...
import {createMessages, getStreetsTitlesofHouses, getStreetTitlesOfGovermentsBuldings} from "./05_02";
...
test("list of streets titles of goverments buildings", () => {
    let streetsNames = getStreetTitlesOfGovermentsBuldings(city.governmentBuildings);
